 ...
 * Generated at: 2014-07-08 13:34:03 UTC
...
if(cartelle.size() > 0) {
	for(i = 0; i < cartelle.size(); i++) {
      ...
      out.print( ((CartellaBean)cartelle.get(i)).getCodice() );
      out.write("\">\n");
      out.write("\t\t\t\t\t\t");
      out.print( ((CartellaBean)cartelle.get(i)).getCodice() );
      out.write("\n");
      out.write("\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t(");
      out.print( ((CartellaBean)cartelle.get(i)).getData() );
      out.write("\n");
      out.write("\t\t\t\t\t-\n");
      out.write("\t\t\t\t\t");
      out.print( ((CartellaBean)cartelle.get(i)).getDataDimissione() );
      out.write(")\n");
      out.write("\t\t\t\t</p>\n");
      out.write("\t\t\t\t");
 }
