...
`\textbf{DB to page-schema PazientePage (}`
	...
	fattori_rischio: 
			`\color{blue}{select r.*}`
			`\color{blue}{from paziente as p, rischi\_paziente as r}`
			`\color{blue}{where p.codsan = (:codsan)}`
			`\color{blue}{and p.codsan = r.id\_paziente}`
...
`\textbf{DB to page-schema CartellaPage (}`
	...
	terapie: 
		`\color{blue}{select t.*}`
		`\color{blue}{from cartella\_clinica as c, terapie as t}`
		`\color{blue}{where c.id = ?id?}`
		`\color{blue}{and c.id = t.id\_cartella}`

	diagnosi:
		`\color{blue}{select d.*, m.*}`
		`\color{blue}{from cartella\_clinica as c, diagnosi as d,}`
		`\color{blue}{paziente as p, medico as m}`
		`\color{blue}{where c.id = ?id?}`
		`\color{blue}{and p.codsan = d.id\_paziente}`
		`\color{blue}{and p.codsan = c.codsan}`
		`\color{blue}{and d.id\_medico = m.id}`
